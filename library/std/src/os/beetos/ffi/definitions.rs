...
/// Indicates a particular syscall number as used by the BeetOS/Xous kernel.
#[derive(Copy, Clone)]
#[repr(usize)]
pub enum Syscall {
    MapMemory = 2,
...
#[stable(feature = "rust1", since = "1.0.0")]
#[derive(Copy, Clone)]
/// A list of all known errors that may be returned by the kernel.
#[repr(usize)]
pub enum Error {
    NoError = 0,
    BadAlignment = 1,
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(
            ...
            match self {
                ...
                Error::ServerNotFound => "the requested server could not be found",
...
/// A representation of a connection to a BeetOS service.
