...
#[cfg(not(test))]
#[unsafe(export_name = "_ZN16__rust_internals3std3sys6beetos5alloc8DLMALLOCE")]
static mut DLMALLOC: dlmalloc::Dlmalloc = dlmalloc::Dlmalloc::new();

#[cfg(test)]
unsafe extern "Rust" {
    #[link_name = "_ZN16__rust_internals3std3sys6beetos5alloc8DLMALLOCE"]
